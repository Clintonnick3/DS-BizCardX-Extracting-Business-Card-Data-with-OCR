...
import streamlit as st     # to create interactive web applications.
from PIL import Image      # Python Imaging Library (PIL) and is used for working with images in Python.
import easyocr             # extract text from images.
import sqlite3             # simple way to access db easy portability
import cv2                 # image processing and computer vision tasks.
import numpy as np         # To make powerful array operations
...
# Creating a table to store the business card informations
